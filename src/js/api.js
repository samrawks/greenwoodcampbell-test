...
async function buildSpecialist() {
  ...
  for (let i = 0; i < 10; i++) {
    ...
    specialistArray[i].ProfessionalBackground + '<a href="">View less</a></div></div><div class="col"><button>View full profile</button><button>Book an appointment</button></div><hr></div>';
  }
